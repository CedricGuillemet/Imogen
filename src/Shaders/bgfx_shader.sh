...
#		define texture2D(_sampler, _coord)      texture2D(_sampler, _coord)
#		define texture2DArray(_sampler, _coord) texture2D(_sampler, _coord)
#		define texture3D(_sampler, _coord)      texture2D(_sampler, _coord)
